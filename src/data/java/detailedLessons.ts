...
export function getLessonsForModule(moduleId: string): DetailedLesson[] {
  ...
  const moduleAliases: Record<string, string> = {
    ...
    'p1': 'patterns-star',
    'patterns-star': 'patterns-star',
    'star-patterns': 'patterns-star',
    'p2': 'patterns-number',
    'patterns-number': 'patterns-number',
    'number-patterns': 'patterns-number',
    'p3': 'patterns-character',
    'patterns-character': 'patterns-character',
    'character-patterns': 'patterns-character',
    'p4': 'patterns-matrix',
    'patterns-matrix': 'patterns-matrix',
    'matrix-patterns': 'patterns-matrix',
    '10': 'java-oop-basics',
    'oop': 'java-oop-basics',
