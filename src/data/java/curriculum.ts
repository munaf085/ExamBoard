...
export const JAVA_MODULES: JavaModule[] = [
  ...
  // ── SECTION 2: OBJECT-ORIENTED PROGRAMMING (11 - 16) ──────────────────
  {
    ...
    estimatedMinutes: 60,
    icon: 'Layers',
    topics: ['Why OOP?', 'What is a Class?', 'Creating Objects with new', 'Stack vs Heap & Aliasing', 'Constructors & Overloading', 'this Keyword & Chaining', 'Static vs Instance', 'Garbage Collection & Lifecycle'],
    prerequisites: ['java-methods'],
    lessonCount: 8,
    mcqCount: 40,
    codingCount: 20,
